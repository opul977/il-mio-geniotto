    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            if (containsBadWords(comment) || containsBadWords(name)) {
                toast.error("Il tuo messaggio contiene parole non appropriate. Per favore, usa un linguaggio consono! 😇");
    ...
    return (
        <section className="py-20 px-6 max-w-7xl mx-auto w-full">
            <div className="text-center mb-16 relative">
                ...
                <p className="text-slate-500 font-bold max-w-2xl mx-auto italic mb-8">
                    &quot;Il parere dei genitori e degli studenti è la nostra forza più grande!&quot;
                </p>
                
                {/* Tasto scorrimento mobile */}
                <button 
                    onClick={() => document.getElementById('review-form')?.scrollIntoView({ behavior: 'smooth' })}
                    className="md:hidden inline-flex items-center gap-2 bg-primary text-white px-6 py-3 rounded-full font-black text-xs uppercase tracking-widest shadow-xl shadow-blue-100 animate-bounce"
                >
                    Scrivi la tua recensione ✍️
                </button>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-start">
                ...
                {/* Modulo di Invio */}
                <div id="review-form" className="bg-white/80 backdrop-blur-2xl p-8 rounded-[2.5rem] shadow-2xl border border-white/40 sticky top-32 lg:p-10">
                    {showSuccess ? (
                        <div className="py-12 text-center animate-in zoom-in duration-500">
                            ...
                            <h3 className="text-2xl font-black text-slate-800 mb-4 uppercase tracking-tight">Grazie mille!</h3>
                            <p className="text-slate-500 font-bold mb-8">
                                Il tuo feedback è stato salvato. <br />
                                Sei parte della famiglia di Geniotto! 🐺
                            </p>
                            <button 
                            ...
                            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                                <div className="flex flex-col gap-2">
                                    ...
                                    <input
                                        ...
                                        className="bg-white/50 border-2 border-slate-100 rounded-2xl py-4 px-6 text-sm font-bold focus:border-primary/20 focus:outline-none transition-all placeholder:text-slate-300"
                                        required
                                    />
                                </div>
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <div className="flex gap-3 bg-white/50 p-4 rounded-2xl border-2 border-slate-100 justify-center">
                                        {[1, 2, 3, 4, 5].map((star) => (
                                            <button
                                                key={star}
                                                type="button"
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <textarea
                                        ...
                                        className="bg-white/50 border-2 border-slate-100 rounded-2xl py-4 px-6 text-sm font-bold focus:border-primary/20 focus:outline-none transition-all min-h-[120px] resize-none placeholder:text-slate-300"
                                        required
                                    />
                                </div>
