            ...
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
                ...
                <div className="flex flex-col gap-6 md:gap-10 text-center lg:text-left z-10">
                    ...
                    <div className="flex flex-col sm:flex-row flex-wrap gap-4 justify-center lg:justify-start">
                        ...
                        <a href="https://expo.dev/artifacts/eas/g74fwPKi79rg8givSQ1VAU.apk" download className="group relative bg-slate-800 text-white px-8 py-5 rounded-[2rem] text-lg font-black shadow-xl hover:-translate-y-1 active:scale-95 transition-all overflow-hidden flex items-center justify-center border-2 border-slate-700 hover:border-emerald-500">
                            <span className="relative z-10 flex items-center gap-2">
                                Scarica App V2.9.6 <span className="text-emerald-400 group-hover:scale-125 transition-transform duration-300">📱</span>
                            </span>
                        </a>
